...
const OrderEnquires = ({ setActivePage, setSelectedOrder }) => {
  ...
  const OrderEnquiryData = async () => {
    // This function is kept for compatibility but not used with the sample data
  };
      ...
      <table className="w-full text-[#484848] text-sm table-fixed">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="p-2 text-center font-medium w-[15%]">Order ID</th>
            <th className="p-2 text-center font-medium w-[15%]">Customer</th>
            <th className="p-2 text-center font-medium w-[15%]">Phone</th>
            <th className="p-2 text-center font-medium w-[25%]">Product Name/Part No</th>
            <th className="p-2 text-center font-medium w-[10%]">Quantity</th>
        ...
        <tbody>
          {currentOrders.map((order) => (
            <tr
              ...
              <td className="p-2 text-center cursor-pointer hover:text-blue-600 w-[15%]"
                  onClick={() => {
